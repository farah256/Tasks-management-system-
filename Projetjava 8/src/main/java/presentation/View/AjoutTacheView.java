...
public class AjoutTacheView extends JFrame {
    ...
    public AjoutTacheView() {
        ...
        // Header
        JLabel headerLabel = new JLabel("Ajouter Tache");
        ...
        buttonPanel.setBackground(new Color(98, 22, 203,70)); // Set background color
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            AjoutTacheView frame = new AjoutTacheView();
